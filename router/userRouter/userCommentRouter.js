...
usercommentRouter.post('/', getAllCommentsHandler)
usercommentRouter.post('/createcomment', createCommentHandler)
usercommentRouter.post('/updatecomment', updateCommentHandler)
usercommentRouter.post('/deletecomment', deleteCommentHandler)
